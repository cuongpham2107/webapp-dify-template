...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        console.error("Error in GET /api/admin/users/[id]/access:", error);
...
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        console.error("Error in POST /api/admin/users/[id]/access:", error);
...
export async function PUT(request: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        console.error("Error in PUT /api/admin/users/[id]/access:", error);
...
export async function DELETE(request: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        console.error("Error in DELETE /api/admin/users/[id]/access:", error);
