...
const uploadRemoteFileInfo = (url: string, token: boolean): Promise<RemoteFileResponse> => {
  // TODO: Implement actual remote file upload logic
  return Promise.reject(new Error('Remote file upload not implemented'))
}
